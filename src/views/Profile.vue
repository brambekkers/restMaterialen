            ...
            try {
                await this.$store.dispatch("alert", {
                    ...
                    msg: {
                        ...
                        text: "Weet je zeker dat je dit account wilt verwijderen? Wanneer je dit account verwijderd verlies je al de data en dit kan niet meer ongedaan worden gemaakt."
                    }
                });
                this.deleteUser();
            } catch (error) {
            ...
            try {
                ...
                this.$store.dispatch("notification", {
                    ...
                    msg: {
                        ...
                        text: "Je account is succesvol verwijderd. Als jouw data is verwijderd en je kunt vanaf nu niet meer inloggen."
                    }
                });
