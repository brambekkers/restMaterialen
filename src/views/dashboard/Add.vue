										...
										<div class="col-4 col-xl-2">
											<div class="form-group">
												...
												>
													...
													<option value="ms">Massiefhout</option>
												</select>
											</div>
										</div>
									...
									<div class="row justify-content-between">
										...
										<div class="col-md-6 col-xl-4">
											<div class="row">
												<div class="col-8 col-md-6 col-xl-8">
													<div class="form-group">
														<label>Label</label>
														<input type="text" v-model="tag" placeholder class="form-control border-input" />
													</div>
												</div>
												<div class="col-4 col-md-6 col-xl-4">
													<button class="btn btn-outline-primary mt-4" @click.prevent="addTag">Voeg toe</button>
												</div>
											</div>
										</div>
										<!-- Image -->
										<div class="col-md-6 col-xl-4">
											<div class="row">
												...
												<div class="col-4 col-md-6 col-xl-4">
													<button class="btn btn-outline-primary mt-4" @click.prevent="addImage">Voeg toe</button>
												</div>
											</div>
										</div>
										<!-- Labels -->
