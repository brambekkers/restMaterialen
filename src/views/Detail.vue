    ...
    <div class="main-content">
        <div class="container">
            ...
            <div class="d-flex justify-content-between">
                <router-link tag="button" to="/libary" class="btn btn-default"> <i class="fas fa-arrow-circle-left mr-3"></i>Terug </router-link>

                <router-link :to="`/reservation/${$route.params.id}`" tag="button" class="btn btn-info" v-if="user">
                    Reserveer
