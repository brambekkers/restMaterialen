                                    ...
                                    <div class="tab-pane active" v-if="step === 1">
                                        <form @submit.prevent="next()">
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-10">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control valid" placeholder="Voornaam" required v-model="newUser.firstName" />
                                                    </div>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text">
                                                        ...
                                                        <input type="text" placeholder="Achternaam" class="form-control" required v-model="newUser.lastName" />
                                                    </div>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text">
                                            ...
                                            <div class="pull-right mt-5">
                                                <button type="submit" class="btn btn-next btn-fill btn-rose btn-wd valid" v-if="step < 3">Volgende</button>
                                            </div>
                                        </form>
                                    </div>
                                    <!-- Step 2 -->
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-10">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" class="form-control valid" placeholder="Studentennummer" required v-model.number="newUser.studentNumber" />
                                                    </div>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text pr-2">
                                                        ...
                                                        <input type="text" placeholder="Klas" class="form-control" required v-model="newUser.class" />
                                                    </div>
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-10">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="password" class="form-control valid" placeholder="Wachtwoord" required v-model="newUser.password" />
                                                    </div>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text">
                                                        ...
                                                        <input type="password" placeholder="Controle wachtwoord" class="form-control" required v-model="newUser.passwordCheck" />
                                                    </div>

                                                    <Checkbox class="mt-5" @toggleCheck="newUser.privacyCheck = $event" :link="'/privacy'" />
                                                </div>
                                            </div>
                                            <div class="pull-right mt-5">
